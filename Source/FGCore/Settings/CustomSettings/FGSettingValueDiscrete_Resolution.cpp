...
#include "FGSettingValueDiscrete_Resolution.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(FGSettingValueDiscrete_Resolution)

#define LOCTEXT_NAMESPACE "FGSettings"

UFGSettingValueDiscrete_Resolution::UFGSettingValueDiscrete_Resolution()
{
}

void UFGSettingValueDiscrete_Resolution::OnInitialized()
{
	Super::OnInitialized();
...
void UFGSettingValueDiscrete_Resolution::StoreInitial()
{
	// Ignored
}

void UFGSettingValueDiscrete_Resolution::ResetToDefault()
{
	// Ignored
}

void UFGSettingValueDiscrete_Resolution::RestoreToInitial()
{
	// Ignored
}

void UFGSettingValueDiscrete_Resolution::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 UFGSettingValueDiscrete_Resolution::GetDiscreteOptionIndex() const
{
...
TArray<FText> UFGSettingValueDiscrete_Resolution::GetDiscreteOptions() const
{
...
void UFGSettingValueDiscrete_Resolution::OnDependencyChanged()
{
...
void UFGSettingValueDiscrete_Resolution::InitializeResolutions()
{
	Resolutions.Empty();
...
void UFGSettingValueDiscrete_Resolution::SelectAppropriateResolutions()
{
...
bool UFGSettingValueDiscrete_Resolution::ShouldAllowFullScreenResolution(const FScreenResolutionRHI& SrcScreenRes, int32 FilterThreshold) const
{
...
int32 UFGSettingValueDiscrete_Resolution::FindIndexOfDisplayResolution(const FIntPoint& InPoint) const
{
...
int32 UFGSettingValueDiscrete_Resolution::FindIndexOfDisplayResolutionForceValid(const FIntPoint& InPoint) const
{
...
int32 UFGSettingValueDiscrete_Resolution::FindClosestResolutionIndex(const FIntPoint& Resolution) const
{	
	int32 Index = 0;
...
void UFGSettingValueDiscrete_Resolution::GetStandardWindowResolutions(const FIntPoint& MinResolution, const FIntPoint& MaxResolution, float MinAspectRatio, TArray<FIntPoint>& OutResolutions)
{
...
FText UFGSettingValueDiscrete_Resolution::FScreenResolutionEntry::GetDisplayText() const
{
