...
#include "FGSettingValueDiscrete_Resolution.generated.h"
...
UCLASS()
class UFGSettingValueDiscrete_Resolution : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	UFGSettingValueDiscrete_Resolution();
